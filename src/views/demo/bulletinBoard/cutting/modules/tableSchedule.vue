    ...
    <div v-show="state.showFlag">
      ...
      <div class="table_body">
        <div class="table_th">
          ...
          <div class="tr2 th_style">订单号</div>
          <div class="tr3 th_style">成衣车间</div>
          <div class="tr4 th_style">面料</div>
          <div class="tr5 th_style">订单件数</div>
          <div class="tr6 th_style">已完成件数</div>
          <div class="tr7 th_style">达成率</div>
        </div>
        <div class="table_main_body" :style="{ height: state.height + 'vh' }">
          <div class="table_inner_body" :style="{ top: state.tableTop + 'px' }">
            <div v-for="(item, index) in state.tableList" :key="index" class="table_tr">
              ...
              <div class="tr6 tr">{{ item.number }}</div>
              <div class="tr7 tr">{{ item.completion }}%</div>
            </div>
          </div>
        </div>
      </div>
