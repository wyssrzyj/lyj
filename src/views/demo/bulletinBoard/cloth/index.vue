    ...
    <div class="mainBody">
      ...
      <div class="mainBody-left">
        ...
        <div class="left-top-content">
          ...
          <div>
            <tableRoll2 :data="state.data.leftData2" :height="20" />
          </div>
        </div>
        <div class="left-top-content">
          <div class="left-top">
      ...
      <div class="mainBody-centre">
        ...
        <div class="category">
          ...
          <div class="category1">
            ...
            <div class="category-title-3">当日裁剪时间</div>
          </div>
        </div>
        ...
        <div class="left-top-content">
          ...
          <div class="broken">
            <div class="cropLayout">
              <img
                class="bottomColor-Broken"
                src="./modules/img/bottomColor.png"
                alt=""
              />
        ...
        <div class="switch">
          <div
            v-for="item in state.bottomList"
            :key="item.id"
            :class="item.type ? 'switchSubitem' : 'switchSubitem-no'"
          />
        </div>
      </div>
      <!-- 右侧 -->
          ...
          <div class="left-top-content">
            <div class="maintenance">
              <img
                ...
                src="./modules/img/maintenance.png"
                alt=""
              />
              累计维修测试:
              <div class="maintenanceSum">{{ state.type * 17 }}次</div>
            </div>
            <div class="left-top-content">
              <div class="cropLayout">
...
const setType = (e: any) => {
  const data = cloneDeep(state.bottomList);
  data.map((item: any) => {
    if (item.only === e) {
      item.type = true;
    } else {
