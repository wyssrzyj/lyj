<template>
  <div>
    ...
    <div class="ball">
      <svg xlink="https://www.w3.org/1999/xlink" x="0px" y="0px" style="display: none">
        <!-- 定义可复用的 icon -->
        <symbol id="wave">
...
<script lang="ts" setup>
  ...
  //数量
  let count = props.number

  nextTick(() => {
    let countEL: any = document.getElementById(countSVG.value)
    let waterEl: any = document.getElementById(waterSVG.value)
